...
Ths script scans the DigiCert CT database for certificates related to Marinus SSL_Orgs.
...
This script assumes that it is being executed from /mnt/workspace/.
Data is written to: /mnt/workspace/ct_digicert/.

The certificate transparency github project must be installed in /mnt/workspace/certificate-transparency/
The certificate transparency code can be found at: https://github.com/google/certificate-transparency/
"""
...
gflags.DEFINE_string("output", "/mnt/workspace/ct_digicert/",
...
def write_matched_certificate(matcher_output):
    """
    Callback for writing the matched certificate to the file system
    """
