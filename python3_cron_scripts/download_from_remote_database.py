...
def download_zgrab_info(zgrab_data_collection, remote_zgrab_data_collection):
    """
    ...
    # Insert the new results from the remote server into the local server
    print("Beginning ZGrab IP inserts...")
    ...
    # Insert the new results from the remote server into the local server
    print("Beginning ZGrab domain inserts...")
...
def download_zgrab_port_info(zgrab_data_collection, remote_zgrab_data_collection):
    """
    Download the latest zgrab IP scan information.
    """
    # Grab more than 24 hours back to reduce risk of time diff bugs
    ...
    # Insert the new results from the remote server into the local server
    print("Beginning ZGrab port inserts...")
    for result in ip_results:
        zgrab_data_collection.update({'ip':result['ip']}, result, upsert=True)
...
def download_whois_data(whois_collection, remote_whois_collection):
    """
    Download the latest whois information.
    """
    print("Beginning Whois download")
...
#                                           "$set": {'status': 'READY'}})
    ...
    download_zgrab_info(zgrab_443_data_collection, remote_zgrab_443_data_collection)
    ...
    download_zgrab_info(zgrab_80_data_collection, remote_zgrab_80_data_collection)
    ...
    download_zgrab_port_info(zgrab_port_data_collection, remote_zgrab_port_data_collection)
