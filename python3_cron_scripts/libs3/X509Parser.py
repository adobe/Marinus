...
from cryptography.x509.oid import NameOID, SignatureAlgorithmOID, ExtensionOID, _OID_NAMES
...
class X509Parser(object):
    ...
    CT_LOG_MAP =   {
                ...
                'rocketeer': {'id': '7ku9t3XOYLrhQmkfq+GeZqMPfl+wctiDAMR7iXqo/cs=',
                            'url': 'ct.googleapis.com/rocketeer'},
                'skydiver': {'id': 'u9nfvB+KcbWTlCOXqpJ7RzhXlQqrUugakJZkNo4e0YU=',
                            'url': 'ct.googleapis.com/skydiver'},
                'argon2018': {'id': 'pFASaQVaFVReYhGrN7wQP2KuVXakXksXFEU+GyIQaiU=',
                            'url': 'ct.googleapis.com/logs/argon2018'},
                'argon2019': {'id': 'Y/Lbzeg7zCzPC3KEJ1drM6SNYXePvXWmOLHHaFRL2I0=',
                            'url': 'ct.googleapis.com/logs/argon2019'},
                'argon2020': {'id': 'sh4FzIuizYogTodm+Su5iiUgZ2va+nDnsklTLe+LkF4=',
                ...
                'xenon2020':  {'id':  'B7dcG+V9aP/xsMYdIxXHuuZXfFeUt2ruvGE6GmnTohw=',
                            'url': 'ct.googleapis.com/logs/xenon2020'},
                'xenon2021': {'id': 'fT7y+I//iFVoJMLAyp5SiXkrxQ54CX8uapdomX4i8Nc=',
                ...
                'digicert-ct2': {'id': 'h3W/51l8+IxDmV+9827/Vo1HVjb/SrVgwbTq/16ggw8=',
                            'url': 'ct2.digicert-ct.com'},
                'yeti2018': {'id': 'wRZK4Kdy0tQ5LcgKwQdw1PDEm96ZGkhAwfoHUWT2M2A=',
                            'url': 'yeti2018.ct.digicert.com/log'},
                'yeti2019': {'id': '4mlLribo6UAJ6IYbtjuD1D7n/nSI+6SPKJMBnd3x2/4=',
                            'url': 'yeti2019.ct.digicert.com/log'},
                'yeti2020': {'id': '8JWkWfIA0YJAEC0vk4iOrUv+HUfjmeHQNKawqKqOsnM=',
                            'url': 'yeti2020.ct.digicert.com/log'},
                'yeti2021': {'id': 'XNxDkv7mq0VEsV6a1FbmEDf71fpH3KFzlLJe5vbHDso=',
                ...
                'nessie2020': {'id': 'xlKg7EjOs/yrFwmSxDqHQTMJ6ABlomJSQBujNioXxWU=',
                            'url': 'nessie2020.ct.digicert.com/log'},
                'nessie2021': {'id': '7sCV7o1yZA+S48O5G8cSo2lqCXtLahoUOOZHssvtxfk=',
                ...
                'sirius': {'id': 'FZcEiNe5l6Bb61JRKt7o0ui0oxZSZBIan6v71fha2T8=',
                            'url': 'sirius.ws.symantec.com'},
                'vega': {'id': 'vHjh38X2PGhGSTNNoQ+hXwl5aSAJwIG08/aRfz7ZuKU=',
                            'url': 'vega.ws.symantec.com'},
                # Comodo
                'mammoth': {'id': 'b1N2rDHwMRnYmQCkURX/dxUcEdkCwQApBo2yCJo32RM=',
                ...
                'gdca-log': {'id': 'cX6nQgl1voSicjVT8Xd8Jt1Rr04QIUQJTZAZtGL7Zmg=',
                            'url': 'log.gdca.com.cn'},
                'gdca-log2': {'id': 'FDCNkMzQMBNQBcAcpSbYHoTodiTjm2JI4I9ySuo7tCo=',
                            'url': 'log2.gdca.com.cn'},
                'venafi-ctlog': {'id': 'rDua7X+pZ0dXFZ5tfVdWcvnZgQCUHpve/+yhMTt1eC0=',
                            'url': 'ctlog.api.venafi.com'},
                'gdca-ct': {'id': 'Gjj3bo1vS9GxMAFS0XV1B88iKrHDdVZRF4sBbmGyY0o=',
                            'url': 'ct.gdca.com.cn'},
                'gdca-ctlog': {'id': 'kkow+Qkzb/Q11pk6EKx1osZBco5/wtZZrmGI/61AzgE=',
                            'url': 'ctlog.gdca.com.cn'},
                'daedalus': {'id': 'HQJLjrFJizRN/YfqPvwJlvdQbyNdHUlwYaR3PEOcJfs=',
                            'url': 'ct.googleapis.com/daedalus'},
                'submariner': {'id': 'qJnYeAySkKr0YvMYgMz71SRR6XDQ+/WR73Ww2ZtkVoE=',
                            'url': 'ct.googleapis.com/submariner'},
                'wosign-ctlog': {'id': 'QbLcLonmPOSvG6e7Kb9oxt7m+fHMBH4w3/rjs7olkmM=',
                            'url': 'ctlog.wosign.com'},
                'izenpe-ct': {'id': 'iUFEnHB0Lga5/JznsRa6ACSqNtWa9E8CBEBPAPfqhWY=',
                            'url': 'ct.izenpe.eus'},
                'startssl-ct': {'id': 'NLtq1sPfnAPuqKSZ/3iRSGydXlysktAfe/0bzhnbSO8=',
                            'url': 'ct.startssl.com'},
                }
        ...
        for entry in names:
            for oid in oid_names:
                if entry.oid == getattr(NameOID, oid):
                    self.__add_co_array_value(cert_object, source + "_" + oid.lower(), entry.value)
                    continue
    ...
    def __get_alternative_names(self, cert_object, extensions):
        ...
        try:
            alt_names = extensions.get_extension_for_oid(ExtensionOID.SUBJECT_ALTERNATIVE_NAME)
    ...
    def __get_extended_key_usages(self, cert_object, extensions):
        ...
        try:
            ext_key_usage = extensions.get_extension_for_oid(ExtensionOID.EXTENDED_KEY_USAGE)
    ...
    def __get_basic_constraints(self, cert_object, extensions):
        ...
        """
        try:
            constraints = extensions.get_extension_for_oid(ExtensionOID.BASIC_CONSTRAINTS)
    ...
    def __parse_sct(self, asn1_sctList, sct_type):
        ...
        while bytes_read < total_len:
            ...
            scts.append({'log_name': self.__find_ct_log_url_by_id(logid),
                        ...
                        'hash_alg': hash_alg,
                        'sig_alg': sig_alg,
                        'sig_alg_name': self.__SCT_get_signature_nid(version, hash_alg, sig_alg),
