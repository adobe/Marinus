...
"""
This script queries Infoblox for the extattr information from the "A" records
...
def main(logger=None):
    ...
    jobs_manager = JobsManager.JobsManager(mc, "get_infoblox_a_extattrs")
    jobs_manager.record_job_start()

    iem = InfobloxExtattrManager.InfobloxExtattrManager("a")
