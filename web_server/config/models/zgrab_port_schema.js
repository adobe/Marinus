...
{'_id': 'ObjectId',
 'aws': 'Boolean',
 'azure': 'Boolean',
 'data': {'smtp': {'banner': 'String',
                   'ehlo': 'String',
                   'starttls': 'String',
                   'timestamp': 'Date',
                   'tls': {'server_certificates': {'certificate': {'parsed': {'extensions': {'authority_info_access': {'issuer_urls': [],
                                                                                                                       'ocsp_urls': []},
          ...
          'tls': {'server_certificates': {'certificate': {'parsed': {'extensions': {'authority_info_access': {'issuer_urls': [],
                  ...
                  'server_hello': {'cipher_suite': {'hex': 'String',
                                   ...
                                   'version': {'name': 'String',
                                               'value': 'Number'}},
                  'server_key_exchange': {'dh_params': {'generator': {'length': 'Number',
                                                                      'value': 'String'},
                                                        'prime': {'length': 'Number',
                                                                  'value': 'String'},
